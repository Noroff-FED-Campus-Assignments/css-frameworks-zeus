...
const posts = [
  {
    ...
    href: "#",
    description: `Water is life, yet millions face a growing water shortage crisis. Let's conserve, reuse, and protect this precious resource for a sustainable future. 💧 #WaterShortage #SaveWater #Sustainability`,
    date: "Mar 15, 2020",
    datetime: "2020-03-16",
  ...
  },
  {
    ...
    title: "Boost your conversion rate",
    href: "#",
    description: `What a thrilling game last night! The teams gave it their all, and the final score had us on the edge of our seats. Sports at its finest! 🏈 #BigGame #EpicMatchup`,
    date: "Mar 16, 2020",
    datetime: "2020-03-16",
    category: { title: "Marketing", href: "#" },
    author: {
  ...
  },
  {
    ...
    title: "Boost your conversion rate",
    href: "#",
    description: `Excitement is building for tonight's live concert! 🎶 Join us for an unforgettable night filled with music, energy, and unforgettable moments. Grab your tickets and let's make memories! 🎤🤩 #LiveMusic #ConcertNight`,
    date: "Mar 20, 2020",
    datetime: "2020-03-16",
    category: { title: "Marketing", href: "#" },
    author: {
